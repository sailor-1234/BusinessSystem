...
body {
	...
	background-image: url(qiantai/qimg/bg2.jpg);
  ...
  <div id="ContainerPanel" style="display: none;">
		...
		<div class="zt">
			<div id="H">
				...
				<div id="CImage-332778-43073-2" style="background-image:url('qiantai/qimg/bg.jpg'); height:150px;">
					<img src="qiantai/qimg/header-2.png" border="0" alt="">
				</div>
			</div>
